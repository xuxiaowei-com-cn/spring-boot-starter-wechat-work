...
public class OAuth2WeChatWorkWebsiteConfiguration {
	...
	public WeChatWorkWebsiteService weChatWorkWebsiteService() {
		return new InMemoryWeChatWorkWebsiteService(weChatWorkWebsiteProperties);
	}
