...
public class OAuth2WeChatWorkWebsiteAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	 ...
	 * 授权类型：企业微信 扫码授权登录
	 */
	public static final AuthorizationGrantType WECHAT_WORK_WEBSITE = new AuthorizationGrantType("wechat_work_website");
	 ...
	 */
	public OAuth2WeChatWorkWebsiteAuthenticationToken(Authentication clientPrincipal,
			Map<String, Object> additionalParameters, String appid, String agentid, String code, String scope,
			String remoteAddress, String sessionId, String state, String binding) {
		super(OAuth2WeChatWorkWebsiteAuthenticationToken.WECHAT_WORK_WEBSITE, clientPrincipal, additionalParameters);
